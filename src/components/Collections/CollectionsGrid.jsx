...
// Ten grid w ogóle nie miał serca ani żadnego zapisu do Supabase — karty były
// czysto statyczne. Dodane tu serce działa dokładnie tak samo jak w
// CatalogGrid.jsx: wczytuje ulubione zalogowanego usera przy montowaniu,
// klik zapisuje/usuwa wiersz w tabeli `favorites` z optymistyczną zmianą UI.
